public class ProgramaPrincipalVeterinaria {
    public static void main(String[] args) {
        ...
        medicamentos2[0] = "fewnf";
        medicamentos2[1] = "skjf";
        medicamentos2[2] = "kjbwef";
        ...
        medicamentos4[0] = "fewnf";
        medicamentos4[1] = "skjf";
        ...
        System.out.println("El promedio total era" + hacerPromedioTotal(Veterinaria));
    }
