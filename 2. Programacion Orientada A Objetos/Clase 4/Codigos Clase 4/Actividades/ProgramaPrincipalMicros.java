...
y hora de salida “5:00 am”. Luego, cargue pasajeros en el micro de la siguiente manera: Leer
nros. de asientos desde teclado que corresponden a pedidos de personas. La lectura finaliza
...
public class ProgramaPrincipalMicros {
    public static void main(String[] args) {
        ...
        Micro MicroMarDelPlata = new Micro();
